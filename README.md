...
| `/:locale/picks`                               | The recommender, ranked under the running experiment; every save, dismissal and click is an outcome |
| `/:locale/experiments/:key`                    | Per-arm results with errors and sample sizes; no comparison below thirty sessions per arm           |
